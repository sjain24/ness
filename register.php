    ...
    <section id="contact" class="tm-section-pad-top tm-parallax-2">
      	<div class="container tm-container-contact">
            ...
            <div class="footer-social d-flex align-items-center">
									<a href="https://www.facebook.com/alcheringaiitg"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="https://twitter.com/alcheringaiitg"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                    <a href="https://www.youtube.com/user/iitgalcher"><i class="fa fa-youtube" aria-hidden="true"></i></a>
                                    <a href="https://plus.google.com/+alcheringa"><i class="fa fa-google" aria-hidden="true"></i></a>
                                    <a href="https://www.linkedin.com/company/alcheringaiitguwahati/"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                                    <a href="https://www.instagram.com/alcheringaiitg/"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                                    <a href="https://in.pinterest.com/alcheringaiitg/"><i class="fa fa-pinterest" aria-hidden="true"></i></a>
								</div>
        </div>
      </div>
      <footer class="text-center small tm-footer">
          <p class="mb-0">
            Copyright &copy; 2020 Alcheringa<br>
